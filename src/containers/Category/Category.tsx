      ...
      <Row>
        <Col md={12}>
          ...
          <Wrapper style={{ boxShadow: "0 0 5px rgba(0, 0 , 0, 0.05)" }}>
            <TableWrapper>
              <StyledTable $gridTemplateColumns="minmax(70px, 70px) minmax(70px, max-content) minmax(70px, max-content) minmax(150px, auto) minmax(150px, auto)">
                <StyledHeadCell>
                  <Checkbox
                    type="checkbox"
                    value="checkAll"
                    ...
                    data.categories.map((row, index) => (
                      <React.Fragment key={index + 1}>
                        <StyledCell>
                          <Checkbox
                            name={index + 1}
                            checked={checkedId.includes(index + 1)}
                        ...
                        <StyledCell>{row["slug"]}</StyledCell>
